// Integration tests that drive the op-cartesi Engine API shim with op-node's
// own client code. Kept in a separate module so the shim itself does not
// depend on the optimism monorepo.
module github.com/tuler/op-cartesi/integration
