...
| [docs/BLOCKS-SPEC.md](docs/BLOCKS-SPEC.md) · [ENGINE-RPC-SPEC.md](docs/ENGINE-RPC-SPEC.md) | What a node computes — the state transition, the header and its commitments — and what it serves over JSON-RPC. |
