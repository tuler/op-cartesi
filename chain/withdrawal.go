...
//
// The guest encodes these and this package decodes them, so the two are
// pinned by a file both read rather than by constants copied between them:
// conformance/encodings/withdrawal.json — generated by
// TestConformanceWithdrawal, replayed by the guest's
// evm-compat/js/test/conformance.test.ts.
